...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    let newArray = zooAnimals.map(item => item.animal_name.toLowerCase());
  ...
  */
  ...
  function USApop(arr){
    const totalPop = arr.reduce((acc, item) => { return acc + item.population }, 0);
    return totalPop;
  }
...
// console.log('cubeTwo volume', cubeTwo.cubeVolume());
// console.log('cubeTwo surface area', cubeTwo.cubeSurfaceArea());
